...
#define I2C_Extender_EN

// button sensing pin
#define BTN_REG &PINC
#define BTN_IDX 3
#define BTN_PRESS_SHORT 50  // 50ms
#define BTN_PRESS_LONG 500 // 500ms
...
#ifdef RED_LED_REG
      //I2C_Extender.digitalWrite(channelR,state) ;
...
#ifdef GREEN_LED_REG
      //I2C_Extender.digitalWrite(channelG,state) ;
...
#ifdef BLUE_LED_REG
      //I2C_Extender.digitalWrite(channelB,state) ;
      //pinRedLed.write(state);
#endif
  }
